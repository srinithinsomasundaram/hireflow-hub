        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="divide-y">
              {filtered.map(c => (
                <Link
                  key={c.id} to="/candidates/$id" params={{ id: c.id }}
                ...
                >
                  ...
                  <p className="w-44 hidden sm:block text-xs text-muted-foreground truncate">
                    {c.current_company ?? <span className="text-muted-foreground/40">—</span>}
                  </p>
                  <p className="w-16 hidden sm:block text-xs text-muted-foreground text-right tabular-nums">
                    {c.experience_years != null ? `${c.experience_years} yr` : <span className="text-muted-foreground/40">—</span>}
                  </p>
